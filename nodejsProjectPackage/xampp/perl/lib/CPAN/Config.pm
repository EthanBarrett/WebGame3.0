...
if ( -d '\\WebGame3.0\\nodejsProjectPackage\\xampp\\minicpan' ) {
  ...
  unless ( $@ ) {
    if ( LWP::Online::online() ) {
      push @urllist, q[file:////WebGame3.0/nodejsProjectPackage/xampp/minicpan/];
    } else {
      unshift @urllist, q[file:////WebGame3.0/nodejsProjectPackage/xampp/minicpan/];
    }
  }
}
