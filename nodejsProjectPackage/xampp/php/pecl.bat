...
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\WebGame3.0\nodejsProjectPackage\xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\WebGame3.0\nodejsProjectPackage\xampp\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\WebGame3.0\nodejsProjectPackage\xampp\php\php.exe"
GOTO :INSTALLED
